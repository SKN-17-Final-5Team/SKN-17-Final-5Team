...
COLLECTION_NAME = "trade_collection_test(2)"
...
DOCS_TOKEN = [
    {
        "doc_id": "incoterms",
        "path": "Target_data/Incoterms_preprocessed.md",
        "max_tokens": 128,
        "overlap": 0.15,
    },
    {
        "doc_id": "fraud",
        "path": "Target_data/2025무역사기예방및대응매뉴얼.md",
        "max_tokens": 128,
        "overlap": 0.15,
    },
    {
        "doc_id": "claim",
        "path": "Target_data/무역클레임중재 50문50답(전처리).txt",
        "max_tokens": 128,
        "overlap": 0.15,
    },
    {
        "doc_id": "certification",
        "path": "Target_data/certifications.jsonl",
        "max_tokens": 128,
        "overlap": 0.15,
    },
]
