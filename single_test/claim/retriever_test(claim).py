...
def main():
    DOCUMENT_PATH = "/Users/woojin/Desktop/무역_AI_Copliot/woojin/claim/무역클레임중재 50문50답(전처리).txt"
    QA_PATH = "/Users/woojin/Desktop/무역_AI_Copliot/woojin/claim/claim_test.json"
    K = 5
